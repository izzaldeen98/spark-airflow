...
with DAG(
    ...
    dag.doc_md = """
            ...
            - This DAG **should not** be triggered manually; it must be triggered by the preceding DAG, **`nba_staging`**.

            #### **Execution Steps**
            1. Retrieve the execution date.
            2. Execute the Spark job **`nba_prod_spark_job`** to perform ETL operations.
